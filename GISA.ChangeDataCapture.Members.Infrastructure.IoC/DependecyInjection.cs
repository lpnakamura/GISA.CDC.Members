...
using GISA.ChangeDataCapture.Members.Application.Mappings;
using GISA.ChangeDataCapture.Members.Application.Notifications;
using GISA.ChangeDataCapture.Members.Application.Services;
using GISA.ChangeDataCapture.Members.Domain.Contracts;
using GISA.ChangeDataCapture.Members.Infrastructure.Data.Configurations;
using GISA.ChangeDataCapture.Members.Infrastructure.Data.Contracts;
using GISA.ChangeDataCapture.Members.Infrastructure.Data.Repositories;
...
namespace GISA.ChangeDataCapture.Members.Infrastructure.IoC
{
    public static class DependecyInjection
    {
        public static IServiceCollection AddInfrastructure(this IServiceCollection services)
        {
            ...
            services.AddSingleton<IChangeDataCaptureObserver, MemberObserverService>();
        ...
        {
            services.AddAutoMapper(typeof(MemberMapping));
        }
